...
<ol>
  <li>
<code class="language-plaintext highlighter-rouge">jupyter notebook</code> command reads the <code class="language-plaintext highlighter-rouge">LANG</code> environment variable at startup,
...
<ul>
  <li>
<em>pybabel</em> (could be installed <code class="language-plaintext highlighter-rouge">pip install babel</code>)</li>
  <li>
<em>po2json</em> (could be installed with <code class="language-plaintext highlighter-rouge">npm install -g po2json</code>)</li>
</ul>
...
<ul>
  <li>
<em>notebook/i18n/notebook.pot</em> - Console and startup messages, basically anything that is
produced by Python code.</li>
  <li>
<em>notebook/i18n/nbui.pot</em> - User interface strings, as extracted from the Jinja2 templates
in <em>notebook/templates/*.html</em>
</li>
  <li>
<em>noteook/i18n/nbjs.pot</em> - JavaScript strings and dialogs, which contain much of the visible
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">rename_msg</span> <span class="o">=</span> <span class="nf">function </span><span class="p">(</span><span class="nx">type</span><span class="p">)</span> <span class="p">{</span>
  <span class="k">switch </span><span class="p">(</span><span class="nx">type</span><span class="p">)</span> <span class="p">{</span>
    <span class="k">case</span> <span class="dl">"</span><span class="s2">file</span><span class="dl">"</span><span class="p">:</span>
      <span class="k">return</span> <span class="nf">_</span><span class="p">(</span><span class="dl">"</span><span class="s2">Enter a new file name:</span><span class="dl">"</span><span class="p">);</span>
    <span class="k">case</span> <span class="dl">"</span><span class="s2">directory</span><span class="dl">"</span><span class="p">:</span>
      <span class="k">return</span> <span class="nf">_</span><span class="p">(</span><span class="dl">"</span><span class="s2">Enter a new directory name:</span><span class="dl">"</span><span class="p">);</span>
    <span class="k">case</span> <span class="dl">"</span><span class="s2">notebook</span><span class="dl">"</span><span class="p">:</span>
      <span class="k">return</span> <span class="nf">_</span><span class="p">(</span><span class="dl">"</span><span class="s2">Enter a new notebook name:</span><span class="dl">"</span><span class="p">);</span>
    <span class="nl">default</span><span class="p">:</span>
      <span class="k">return</span> <span class="nf">_</span><span class="p">(</span><span class="dl">"</span><span class="s2">Enter a new name:</span><span class="dl">"</span><span class="p">);</span>
  <span class="p">}</span>
<span class="p">};</span>
</code></pre></div></div>
...
<div class="highlight"><pre class="highlight"><code>./setup.py extract_messages
</code></pre></div>    </div>
  </li>
</ol>
